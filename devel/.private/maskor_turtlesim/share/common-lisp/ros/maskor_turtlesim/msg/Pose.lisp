...
(cl:in-package maskor_turtlesim-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <Pose>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Pose)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name maskor_turtlesim-msg:<Pose> is deprecated: use maskor_turtlesim-msg:Pose instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <Pose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader maskor_turtlesim-msg:x-val is deprecated.  Use maskor_turtlesim-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <Pose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader maskor_turtlesim-msg:y-val is deprecated.  Use maskor_turtlesim-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'theta-val :lambda-list '(m))
(cl:defmethod theta-val ((m <Pose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader maskor_turtlesim-msg:theta-val is deprecated.  Use maskor_turtlesim-msg:theta instead.")
  (theta m))

(cl:ensure-generic-function 'linear_velocity-val :lambda-list '(m))
(cl:defmethod linear_velocity-val ((m <Pose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader maskor_turtlesim-msg:linear_velocity-val is deprecated.  Use maskor_turtlesim-msg:linear_velocity instead.")
  (linear_velocity m))

(cl:ensure-generic-function 'angular_velocity-val :lambda-list '(m))
(cl:defmethod angular_velocity-val ((m <Pose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader maskor_turtlesim-msg:angular_velocity-val is deprecated.  Use maskor_turtlesim-msg:angular_velocity instead.")
  (angular_velocity m))
