...
(cl:defmethod cl:initialize-instance :after ((m <Color>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Color)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name maskor_turtlesim-msg:<Color> is deprecated: use maskor_turtlesim-msg:Color instead.")))

(cl:ensure-generic-function 'r-val :lambda-list '(m))
(cl:defmethod r-val ((m <Color>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader maskor_turtlesim-msg:r-val is deprecated.  Use maskor_turtlesim-msg:r instead.")
  (r m))

(cl:ensure-generic-function 'g-val :lambda-list '(m))
(cl:defmethod g-val ((m <Color>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader maskor_turtlesim-msg:g-val is deprecated.  Use maskor_turtlesim-msg:g instead.")
  (g m))

(cl:ensure-generic-function 'b-val :lambda-list '(m))
(cl:defmethod b-val ((m <Color>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader maskor_turtlesim-msg:b-val is deprecated.  Use maskor_turtlesim-msg:b instead.")
  (b m))
