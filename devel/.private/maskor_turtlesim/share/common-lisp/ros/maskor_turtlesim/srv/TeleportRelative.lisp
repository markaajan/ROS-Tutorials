...
(cl:defmethod cl:initialize-instance :after ((m <TeleportRelative-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TeleportRelative-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name maskor_turtlesim-srv:<TeleportRelative-request> is deprecated: use maskor_turtlesim-srv:TeleportRelative-request instead.")))

(cl:ensure-generic-function 'linear-val :lambda-list '(m))
(cl:defmethod linear-val ((m <TeleportRelative-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader maskor_turtlesim-srv:linear-val is deprecated.  Use maskor_turtlesim-srv:linear instead.")
  (linear m))

(cl:ensure-generic-function 'angular-val :lambda-list '(m))
(cl:defmethod angular-val ((m <TeleportRelative-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader maskor_turtlesim-srv:angular-val is deprecated.  Use maskor_turtlesim-srv:angular instead.")
  (angular m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<TeleportRelative-request>)))
  ...
  "maskor_turtlesim/TeleportRelativeRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'TeleportRelative-request)))
  "Returns string type for a service object of type 'TeleportRelative-request"
  "maskor_turtlesim/TeleportRelativeRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <TeleportRelative-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TeleportRelative-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name maskor_turtlesim-srv:<TeleportRelative-response> is deprecated: use maskor_turtlesim-srv:TeleportRelative-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<TeleportRelative-response>)))
  ...
  "maskor_turtlesim/TeleportRelativeResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'TeleportRelative-response)))
  "Returns string type for a service object of type 'TeleportRelative-response"
  "maskor_turtlesim/TeleportRelativeResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'TeleportRelative)))
  ...
  "maskor_turtlesim/TeleportRelative")