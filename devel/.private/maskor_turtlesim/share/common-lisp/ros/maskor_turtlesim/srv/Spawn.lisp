...
(cl:defmethod cl:initialize-instance :after ((m <Spawn-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Spawn-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name maskor_turtlesim-srv:<Spawn-request> is deprecated: use maskor_turtlesim-srv:Spawn-request instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <Spawn-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader maskor_turtlesim-srv:x-val is deprecated.  Use maskor_turtlesim-srv:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <Spawn-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader maskor_turtlesim-srv:y-val is deprecated.  Use maskor_turtlesim-srv:y instead.")
  (y m))

(cl:ensure-generic-function 'theta-val :lambda-list '(m))
(cl:defmethod theta-val ((m <Spawn-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader maskor_turtlesim-srv:theta-val is deprecated.  Use maskor_turtlesim-srv:theta instead.")
  (theta m))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <Spawn-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader maskor_turtlesim-srv:name-val is deprecated.  Use maskor_turtlesim-srv:name instead.")
  (name m))
...
(cl:defmethod cl:initialize-instance :after ((m <Spawn-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Spawn-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name maskor_turtlesim-srv:<Spawn-response> is deprecated: use maskor_turtlesim-srv:Spawn-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Spawn-response>)))
  ...
  "maskor_turtlesim/SpawnResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Spawn-response)))
  "Returns string type for a service object of type 'Spawn-response"
  "maskor_turtlesim/SpawnResponse")
