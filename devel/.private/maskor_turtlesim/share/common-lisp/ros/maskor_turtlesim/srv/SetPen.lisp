...
(cl:in-package maskor_turtlesim-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <SetPen-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetPen-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name maskor_turtlesim-srv:<SetPen-request> is deprecated: use maskor_turtlesim-srv:SetPen-request instead.")))

(cl:ensure-generic-function 'r-val :lambda-list '(m))
(cl:defmethod r-val ((m <SetPen-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader maskor_turtlesim-srv:r-val is deprecated.  Use maskor_turtlesim-srv:r instead.")
  (r m))

(cl:ensure-generic-function 'g-val :lambda-list '(m))
(cl:defmethod g-val ((m <SetPen-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader maskor_turtlesim-srv:g-val is deprecated.  Use maskor_turtlesim-srv:g instead.")
  (g m))

(cl:ensure-generic-function 'b-val :lambda-list '(m))
(cl:defmethod b-val ((m <SetPen-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader maskor_turtlesim-srv:b-val is deprecated.  Use maskor_turtlesim-srv:b instead.")
  (b m))

(cl:ensure-generic-function 'width-val :lambda-list '(m))
(cl:defmethod width-val ((m <SetPen-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader maskor_turtlesim-srv:width-val is deprecated.  Use maskor_turtlesim-srv:width instead.")
  (width m))

(cl:ensure-generic-function 'off-val :lambda-list '(m))
(cl:defmethod off-val ((m <SetPen-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader maskor_turtlesim-srv:off-val is deprecated.  Use maskor_turtlesim-srv:off instead.")
  (off m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetPen-request>)))
  ...
  "maskor_turtlesim/SetPenRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetPen-request)))
  "Returns string type for a service object of type 'SetPen-request"
  "maskor_turtlesim/SetPenRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <SetPen-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetPen-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name maskor_turtlesim-srv:<SetPen-response> is deprecated: use maskor_turtlesim-srv:SetPen-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<SetPen-response>)))
  ...
  "maskor_turtlesim/SetPenResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'SetPen-response)))
  "Returns string type for a service object of type 'SetPen-response"
  "maskor_turtlesim/SetPenResponse")
